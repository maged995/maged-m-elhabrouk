  ...
  const app = Vue.createApp({
    ...
    data() {
      return {
        ...
        filters: ['All', 'Php', 'Angular', 'Wordpress'],
        currentFilter: 'All',
        ...
        allPortfolioItems: [{
          ...
          imgUrl: '../assets/images/project/3044146.jpg',
          title: {
          ...
          screenshots: {
            img1: {
              url: 'https://nafezly-production.s3.eu-west-3.amazonaws.com/uploads/portfolios/10842_6192f40d6cbd4-1637020685.jpg',
              caption: {
                en: 'caption 5',
                ar: 'تسمية توضيحية 5'
              }
          ...
          imgUrl: 'https://nafezly-production.s3.eu-west-3.amazonaws.com/uploads/portfolios/10842_6192f40d6cbd4-1637020685.jpg',
          title: {
        ...
        testimonialsItems: [{
          imgUrl: 'https://nafezly-production.s3.eu-west-3.amazonaws.com/uploads/portfolios/10842_6192f40d6cbd4-1637020685.jpg',
          quoteContent: {
            en: 'Maged simply provides amazing web development service. Their team is extremely professional and the easiest to meet I have ever worked with. I would recommend Maged to anyone.',
            ar: 'ماجد يقدم خدمات مذهلة في تطوير الويب، ولديه فريق محترف يجعل التعامل معهم مطمئن للغاية. أوصي بفريقهم للجميع.'
          },
          quoteAuthor: {
            en: 'Terrell Grimes',
            ar: 'جابر العواني'
          ...
          quoteContent: {
            en: 'Excellent Team to work with. Always positive to find the most appropriate solution. Maged is one of the professional web development agency that provides awesome services.',
          ...
          imgUrl: 'https://via.placeholder.com/200',
          quoteContent: {
            en: 'Maged team is very professional, always delivers high quality results, and is always there to help. Look forward to working with Maged in other projects.',
          ...
          imgUrl: 'https://via.placeholder.com/200',
          quoteContent: {
            en: 'Maged worked on a handful of projects for us and has always exceeded our expectations. Maged team is dedicated, talented and a delight to work with.',
    ...
    methods: {
      ...
      getAppTheme() {
        ...
        const storageSavedTheme = localStorage.getItem('MagedSavedTheme'); // Check to see if there a saved theme
        ...
        localStorage.setItem('MagedSavedTheme', this.savedTheme);
      },
